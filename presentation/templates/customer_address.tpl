...
<form method="post" action="{$obj->mLinkToAddressDetails}">
	...
	<table class="customer-table">
		<tr>
			<td>Address 1:</td>
			<td>
				<input type="text" name="address1" value="{$obj->mAddress1}" size="32"/>
		...
		<tr>
			<td>Address 2:</td>
			<td>
				<input type="text" name="address2" value="{$obj->mAddress2}" size="32"/>
			</td>
		</tr>
		<tr>
			<td>Town/City:</td>
			<td>
				<input type="text" name="city" value="{$obj->mCity}" size="32"/>
				{if $obj->mCityError}
		...
		<tr>
			<td>Region/State:</td>
			<td>
				<input type="text" name="region" value="{$obj->mRegion}" size="32"/>
				{if $obj->mRegionError}
		...
		<tr>
			<td>Postal Code:</td>
			<td>
				<input type="text" name="postalCode" value="{$obj->mPostalCode}" size="32"/>
		...
		<tr>
			<td>Country:</td>
			<td>
				<input type="text" name="country" value="{$obj->mCountry}" size="32"/>
