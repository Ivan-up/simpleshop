...
<form method="post" action="{$obj->mLinkToAccountDetails}">
	...
	<table class="customer-table">
		...
		<tr>
			<td>Day phone:</td>
			<td>
				<input type="text" name="dayPhone" value="{$obj->mDayPhone}"  size="32"/>
			</td>
		</tr>
		<tr>
			<td>Eve phone:</td>
			<td>
				<input type="text" name="evePhone" value="{$obj->mEvePhone}"  size="32"/>
			</td>
		</tr>
		<tr>
			<td>Mob phone:</td>
			<td>
				<input type="text" name="mobPhone" value="{$obj->mMobPhone}"  size="32"/>
			</td>
		</tr>
		{/if}
	</table>
