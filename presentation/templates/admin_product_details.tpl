...
<form enctype="multipart/form-data" method="post" 
	...
	<h3>
		Edit product: ID #{$obj->mProduct.product_id} &mdash;
		{$obj->mProduct.name} [
	...
	<p>
		...
		<input type="file" name="ImageUpload" value="Upload"/>
	...
	<p>
		...
		<input type="file" name="Image2Upload" value="Upload" />
		<input type="submit" name="Upload" value="Upload" />
	</p>
	...
	<p>
		...
		<input type="file" name="ThumbnailUpload" value="Upload" />
		<input type="submit" name="Upload" value="Upload" />
	</p>
